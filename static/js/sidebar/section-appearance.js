...
// === onclick for buttons ===
function sidebarOnclickAppearanceButtons(element, key, name, value, className) {
    ...
    sidebarApplyAppearanceHome();
};
// ===

// === oninput and onchange for sliders ===
function sidebarOninputAppearanceSlider(element, key, type) {
...
function sidebarOnchangeAppearanceSlider(element, key, type) {
    const range_number = element.parentNode.querySelector('.range_number');
    const range_slider = element.parentNode.querySelector('.range_slider');
...
function sidebarApplyAppearanceButtons() {
    let appearanceSection = document.querySelector('#sidebar-appearance .content');
    ...
    for(const key in settings_state.appearance) {
        ...
        if(k.type.includes('buttons')) {
            let appearanceButtons = domElements[key].querySelectorAll('.sidebar-global_settings_button > *');
...
function sidebarApplyAppearanceSliders() {
    let appearanceSection = document.querySelector('#sidebar-appearance .content');
...
// only settings
function sidebarApplyAppearanceSettings() {
    sidebarApplyAppearanceButtons();    
    sidebarApplyAppearanceSliders();
}; sidebarApplyAppearanceSettings();

// global
function sidebarApplyAppearanceProperties() {
    for(const key in settings_state.appearance) {
        const k = settings_state.appearance[key];
...
function sidebarApplyAppearanceHome() {
